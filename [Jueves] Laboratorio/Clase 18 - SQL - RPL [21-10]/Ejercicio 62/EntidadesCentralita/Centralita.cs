...
namespace EntidadesCentralita
{
    public class Centralita : IGuardar<string>
    {
        ...
        public void Guardar()
        {
            ...
            string mensaje = $"{DateTime.Now.DayOfWeek} {DateTime.Now.Day} de {DateTime.Now.Month} de {DateTime.Now.Year} {DateTime.Now.Hour}:{DateTime.Now.Minute}hs - Se realizo una llamada.";
