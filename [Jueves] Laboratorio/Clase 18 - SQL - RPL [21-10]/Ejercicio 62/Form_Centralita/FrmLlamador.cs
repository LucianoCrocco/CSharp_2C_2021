...
namespace Form_Centralita
{
    public partial class FrmLlamador : Form
    {
        ...
        private LocalDAO bdLocal;
        private ProvincialDAO bdProvincial;
        ...
        public FrmLlamador(Centralita centralita)
        {
            ...
            this.bdLocal = new LocalDAO("DESKTOP-", "Centralita");
            this.bdProvincial = new ProvincialDAO("DESKTOP-", "Centralita");
        }
        ...
        private void btnLlamar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                centralita += llamada;
                switch (llamada.GetType().Name)
                {
                    case "Local":
                        try
                        {
                            bdLocal.Guardar(llamada);
                        }
                        catch (Exception ex)
                        {
