...
namespace View
{
    public partial class FrmView : Form
    {
        ...
        private void FrmView_Load(object sender, EventArgs e)
        {
            ...
            {
                json.Leer(archivoPath, out juegos);
            }
        ...
        private void FrmView_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            try
            {
                json.Guardar("Lista de juegos.txt", juegos);
            }
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            ...
            if (!this.ejecutando)
            {
                ...
                foreach(Juego p in this.juegos)
                {
                    aux = new Task(p.IniciarCarrusel, this.cancellationToken);
                    hilos.Add(aux);
                    aux.Start();
                }
        ...
        private void AvanceJuegos(object sender, short movimiento)
        {
            ...
            if (this.InvokeRequired)
            {
                ...
                object[] obj = new object[] { sender, movimiento };
                this.Invoke(callback, obj);
            }
            else
            {
